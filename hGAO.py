...
class hGATConv(nn.Module):
    ...
    def __init__(self,
        ...
        #TODO: Add a new trainable parameter p
        self.p = nn.Parameter(th.FloatTensor(size=(1,in_feats)))
        #TODO: Will Drop out be affected?
    ...
    # TODO: Add an edge message passing function
    ...
    def forward(self, graph, feat, get_attention=False):
        ...
        with graph.local_scope():
            ...
            # TODO: Add projection and screening process
            # TODO: Add projection process to get importance vector y
            graph.ndata['y'] = th.abs(graph.ndata['ft'].T*self.p)/th.norm(self.p,p=2)
            # TODO: Add edge message passing function to get the weight from src node
            graph.apply_edges(self.n2e_weight_transfer)
            subgraph = select_topk(graph,1,'y')
            # TODO: Tail the features to fit the size of subgraph, since it might be the case that orphan node exist
            # Needed iff the zero indegree is allowed
            # TODO: Below operations should be performed on subgraph
